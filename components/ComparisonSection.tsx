              ...
              <table className="w-full text-left border-collapse min-w-[600px] sm:min-w-full">
                <thead>
                  <tr className="bg-slate-50">
                    <th className="px-6 sm:px-12 py-8 sm:py-10 text-lg sm:text-xl font-bold text-slate-400 w-1/2 border-r border-slate-200">
                      Traditional Lead Gen
                    </th>
                    <th className="px-6 sm:px-12 py-8 sm:py-10 text-lg sm:text-xl font-black text-blue-600 w-1/2 flex items-center gap-3">
                      <Zap className="w-5 h-5 sm:w-6 sm:h-6 fill-blue-600" />
                      Bloom Link System
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                  {/* Row 1: Speed to Lead */}
                  <tr>
                    <td className="px-6 sm:px-12 py-10 sm:py-12 align-top border-r border-slate-100">
                      <p className="text-base sm:text-lg text-slate-600">
                        <span className="font-black text-slate-900 block mb-1">Speed to Lead:</span> 
                        30+ minutes (Lead is cold)
                      </p>
                    </td>
                    <td className="px-6 sm:px-12 py-10 sm:py-12 align-top bg-blue-50/20">
                  ...
                  <tr>
                    ...
                    <td className="px-6 sm:px-12 py-10 sm:py-12 align-top bg-blue-50/20">
                      <div className="flex flex-col">
                        ...
                        <div className="mt-4 inline-flex items-center gap-2 text-[10px] sm:text-xs font-black text-green-600 bg-green-50 px-3 py-1 rounded-full uppercase tracking-widest border border-green-100 self-start">
